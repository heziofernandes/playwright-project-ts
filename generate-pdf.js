...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var browser, page, relativePath, absolutePath, fileUrl;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                absolutePath = path_1.default.resolve(__dirname, relativePath);
                fileUrl = 'file://' + absolutePath.replace(/\\/g, '/');
                return [4 /*yield*/, page.goto(fileUrl, { waitUntil: 'networkidle' })];
            case 3:
                _a.sent();
                return [4 /*yield*/, page.pdf({ path: 'report.pdf', format: 'A4' })];
            case 4:
                _a.sent();
